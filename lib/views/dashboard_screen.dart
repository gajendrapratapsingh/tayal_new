                        ...
                        .map(
                          (e) => InkWell(
                            ...
                            child: Card(
                              elevation: 4.0,
                              color:
                                  e['selected'] ? Colors.indigo : Colors.white,
                              child: Padding(
                                padding: const EdgeInsets.all(6.0),
                                child: Text(e['label'].toString().toUpperCase(),
                                    style: TextStyle(
                                        color: e['selected']
                                            ? Colors.white
                                            : Colors.black,
                  ...
                  child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text(
                              "\u20B9 " +
                                  double.parse(smallValue.toString())
                                      .toStringAsFixed(2),
                              style:
                              ...
                              RadialAxis(
                                  ...
                                  pointers: [
                                    ...
                                    NeedlePointer(
                                        ...
                                        value: double.parse(totalOrderVal),
