...
class _ProductScreenState extends State<ProductScreen> {
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      const Text("Product", textAlign: TextAlign.center, style: TextStyle(fontStyle: FontStyle.normal, fontSize: 21, fontWeight: FontWeight.w600)),
                      Padding(
                  ...
                  Padding(
                    ...
                    child: Container(
                      child: Wrap(
                        spacing: 5.0,
                        runSpacing: 5.0,
                        children: productCategorylist.map((e) => filterChipWidget(chipName: e['category_name'].toString(), categorylist: productCategorylist)).toList()
                      ),
                    ),
                  ),
                  SizedBox(height: 10),
                  Expanded(
                      child: Padding(
                          ...
                          child: _searchResult.length == 0 || _searchResult.isEmpty ? Center(child: Text("No result found")) : GridView.builder(
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Padding(
                                            ...
                                            child: Text(_searchResult[index]['product_name'].toString(),
  ...
  onSearchTextChanged(String text) async {
    if (text.isNotEmpty) {
      ...
      _productlist.forEach((productDetail) {
        if (productDetail['product_name'].toString().toUpperCase().contains(text.toString().toUpperCase())) {
  ...
  Widget filterChipWidget({String chipName, List categorylist}) {
    ...
    return FilterChip(
      ...
      label: Text(chipName),
      labelStyle: TextStyle(color: _isSelected ? Colors.indigo : Colors.black, fontSize: 12.0),
...
class filterChipWidget extends StatefulWidget {
  ...
  filterChipWidget({Key key, this.chipName, this.categorylist}) : super(key: key);
