                            ...
                            child: Stack(
                              children: [
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      padding: EdgeInsets.only(
                                          left: 7.0, right: 7.0),
                                      child: Text(
                                          _searchResult[index]['product_name']
                                              .toString(),
                                          maxLines: 2,
                                ...
                                Positioned(
                                    ...
                                    bottom: 5,
                                    right: 10,
                                    child: _searchResult[index]['is_stock']
                                                    .toString() ==
                                                "0" ||
                                        ...
                                        : _searchResult[index]['quantity'] == 0
                                            ? InkWell(
                                                onTap: () {
                                                  setState(() {
                                                    _searchResult[index]
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Row(
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        onTap: () {
                                                          if (int.parse(_searchResult[
                                                                          index]
                                                                      [
                                                                      'quantity']
                                                                  .toString()) <
                                                              int.parse(_searchResult[
                                                                          index]
                                                                      [
                                                                      'current_stock']
                                                                  .toString())) {
